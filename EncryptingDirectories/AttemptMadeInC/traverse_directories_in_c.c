...
* Possible legitimate use of this program: encrypting user data in the C:\Users directory (recursively, subdirectories too). It will definitely be able to be decrypted later! Why wouldn't it be!
